...
contract Tracking{
    ...
    function createShipment(address _receiver, uint256 _pickupTime , uint256 _distance , uint256 _price) public payable{
        require(msg.value == _price, "Payment amount must match. Please check your transaction.");
    ...
    function getShipmentsCounts(address _sender) public view returns (uint256){
